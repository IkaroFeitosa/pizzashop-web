...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 1231564</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">Ikaro Feitosa</TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="text-muted-foreground">Telefone</TableCell>
              <TableCell className="flex justify-end">(45) 999857268</TableCell>
            </TableRow>
            <TableRow>
